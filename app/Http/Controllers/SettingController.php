...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if(isset($request->site_general_setting))
        {
            ...
            $settings = $request->except(['_token', '_method', 'site_logo', 'site_favicon', 'email_otp', 'site_general_setting', 'site_logo_desktop', 'site_logo_mobile', 'site_logo_icon']);
            ...
            if ($request->hasFile('site_logo_desktop')) {
                ...
                if ($site_logo_setting && $site_logo_setting->val) {
                    ...
                    $relativePath = str_replace($urlPrefix, '', $site_logo_setting->val);
                ...
                $path = $request->file('site_logo_desktop')->store('uploads/settings', 'public');

                $fullUrl = env('APP_URL') . '/public/storage/' . $path;
