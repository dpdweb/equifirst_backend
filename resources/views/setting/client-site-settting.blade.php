            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('settings.update', ['setting' => $settingId ?? 1]) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3" bis_skin_checked="1">
                            <label class="form-label" for="site_logo">⁠Logo ( Desktop ) 1</label>
                            @if(isset($settings['site_logo_desktop']) && $settings['site_logo_desktop'] !='')
                                <br>{{ $settings['site_logo_desktop'] }}
                                <img src="{{ $settings['site_logo_desktop'] }}" width="150" alt="Site Desktop Logo" class="img-thumbnail mt-2" style="max-width: 150px;">
                                <br><br>
                            @endif
