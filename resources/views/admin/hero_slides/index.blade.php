...
@section('body') <body data-sidebar="dark"> @endsection
    ...
    @slot('subtitle')  {{ $singular }} @endslot
    @endcomponent
        ...
        <table id="datatable-tb-grid" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $record->title }}</td>
                    <td><img src="{{ asset('storage/' . $record->image) }}" width="300" /></td>
                    <td>
                        {{-- <a href="{{ route('hero-sliders.edit', $record) }}" class="text-success mx-2">
                            <i class="fas fa-marker" aria-hidden="true"></i>
                        </a> --}}
                        <a href="#" onclick="confirmDelete('{{ route('hero-slides.destroy', $record) }}')" class="text-danger mx-2">
