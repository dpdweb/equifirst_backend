                            ...
                            <tbody>
                                @forelse($records as $record)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <strong>Hero Title:</strong> {{ $record->hero_title }}<br>
                                            <strong>Hero Sub Title:</strong> {{ $record->hero_sub_title }}
                                        </td>
                                        <td>
                                            ...
                                            @endif
                                              <br><br>
                                                    <strong>Image Title:</strong> {{ $record->hero_image_title }}<br>
                                                    <strong>Image Alt:</strong> {{ $record->hero_image_alt }}
