...
@section('title') Social Media Setting @endsection
@section('css')
...
@section('body') <body data-sidebar="dark"> @endsection
    ...
    @slot('page_title') Social Media Setting @endslot
                    ...
                    <form method="POST" action="{{ route('settings.update', ['setting' => $settingId ?? 1]) }}"  enctype="multipart/form-data">
                            ...
                            <div class="mb-3" bis_skin_checked="1">
                                ...
                                <div bis_skin_checked="1">
                                    <input type="url" class="form-control" name="facebook_url" id="facebook_url" value="{{ old('facebook_url', $settings['facebook_url'] ?? '') }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3" bis_skin_checked="1">
                                ...
                                <div bis_skin_checked="1">
                                    <input type="url" class="form-control" name="x_url" id="x_url" value="{{ old('x_url', $settings['x_url'] ?? '') }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3" bis_skin_checked="1">
                                ...
                                <div bis_skin_checked="1">
                                    <input type="url" class="form-control" name="linkedin_url" id="linkedin_url" value="{{ old('linkedin_url', $settings['linkedin_url'] ?? '') }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3" bis_skin_checked="1">
                                ...
                                <div bis_skin_checked="1">
                                    <input type="url" class="form-control" name="youtube_url" id="youtube_url" value="{{ old('youtube_url', $settings['youtube_url'] ?? '') }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3" bis_skin_checked="1">
                                ...
                                <div bis_skin_checked="1">
                                    <input type="url" class="form-control" name="instagram_url" id="instagram_url" value="{{ old('instagram_url', $settings['instagram_url'] ?? '') }}">
                                </div>
                            </div>
