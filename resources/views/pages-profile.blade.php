                    ...
                    <div class="tab-pane" id="post" role="tabpanel">
                        <div>
                            ...
                            <div class="blog-post">
                                <div class="d-flex align-items-center">
                                    <div class="avatar-md me-3">
                                        <img src="{{URL::asset('assets/images/users/avatar-6.jpg')}}" alt="" class="img-fluid rounded-circle img-thumbnail d-block">
                                    </div>
                                    <div class="flex-1">
                            ...
                            <div class="blog-post mt-4">
                                <div class="d-flex align-items-center">
                                    <div class="avatar-md me-3">
                                        <img src="{{URL::asset('assets/images/users/avatar-2.jpg')}}" alt="" class="img-fluid img-thumbnail rounded-circle d-block">
                                    </div>
                                    <div class="flex-1">
