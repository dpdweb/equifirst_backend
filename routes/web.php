...
use App\Http\Controllers\Admin\{ OrganizationController, CategoryController, InventoryController };
...
Route::get('/test-image', function() {
    $filename = '1749754547.jpg'; // Use an actual filename
    echo $path = storage_path('app/public/' . $filename);
